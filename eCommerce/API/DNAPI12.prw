...
//------------------------------+
// Localiza a natureza de venda |
//------------------------------+
DnApi12E(_cCod,_cLoja,_cTipo,@_cNatVnd)
...
If !DnApi12B(_cCgc,_cCod,_cLoja,_cTipo,_cCondPg,_cTpFrete,_cNatVnd,_nTotal,_nValMerc,_nFrete,_nDespesa,_oItems,@_cJson,@_cError)
...
/*/
/**********************************************************************************************************/
Static Function DnApi12A(_cCgc,_lProspect,_nRecno)
Local _cQuery   := ""
Local _cAlias   := ""
...
/*/
/**********************************************************************************************************/
Static Function DnApi12B(_cCgc,_cCod,_cLoja,_cTipo,_cCondPg,_cTpFrete,_cNatVnd,_nTotal,_nValMerc,_nFrete,_nDespesa,_oItems,_cJson,_cError)
Local _cCodProd     := ""
...
//---------------------------+
DnApi12C(_oItems,_nFrete,@_nValMerc,@_nFretePL) 

//-----------------------------+
// Calcula imposto preço venda |
//-----------------------------+
DnApi12D(_cCod,_cLoja,_cTipo,_cTpFrete,_cNatVnd,_nTotal,_nValMerc,_nFretePL,_nFrete,_nDespesa,_oItems,@_aItensPV,@_aTotais)
...
/*/
/**********************************************************************************************************/
Static Function DnApi12C(_oItems,_nFrete,_nValMerc,_nFretePL) 
Local _nX       := 0 
Local _nVlrItem := 0 
Local _nTotItem := 0 
...
/*/
/**********************************************************************************************************/
Static Function DnApi12D(_cCod,_cLoja,_cTipo,_cTpFrete,_cNatVnd,_nTotal,_nValMerc,_nFretePL,_nFrete,_nDespesa,_oItems,_aItensPV,_aTotais)
Local _cTesInt      := ""
Local _cCodProd     := ""
...
For _nX := 1 To Len(_oItems)
    ...
    _cTesInt        := U_FAutoTes(xFilial("SZH"),_cNatVnd,_cCodProd,_cCod,_cLoja)
...
/************************************************************************************************************/
/*/{Protheus.doc} DnApi12E
    @description Regra para retornar Natureza da Nota 
    @type  Static Function
    @author Bernard M Margarido
    @since 05/07/2023
    @version version
/*/
/************************************************************************************************************/
Static Function DnApi12E(_cCod,_cLoja,_cTipo,_cNatVnd)
