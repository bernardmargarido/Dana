...
oDlg := MsDialog():New(0, 0,190, 460,"Executa Rotina Especifica",,,,,,,,,.T.)
	...
	oExec := TGet():New( 040, 010	, {|u| IIF(PCount() > 0, cExec := u, cExec	)} 	, oPanel, 150, 013,"",,,,,,,.T.,,,,,,,.F.,,,"cExec",,,,.T.)

	//-- Botao
    //DEFINE SBUTTON FROM 042,165 TYPE 1 OF oPanel ENABLE ONSTOP "OK" ACTION (oDlg:End())
	_oBtnOk	:= TButton():New( 042, 165 , "OK"     , oPanel, {|| oDlg:End() }	, 042,015,,,.F.,.T.,.F.,,.F.,,,.F. )
