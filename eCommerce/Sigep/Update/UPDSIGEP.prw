...
/*/
//--------------------------------------------------------------------
User Function UPDSIGEP( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSIGEP" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSIGEP" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'SERVICOS CONTRATOS SIGEP'												, ; //X2_NOME
	'SERVICOS CONTRATOS SIGEP'												, ; //X2_NOMESPA
	'SERVICOS CONTRATOS SIGEP'												, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'ETIQUETAS SIGEP'														, ; //X2_NOME
	'ETIQUETAS SIGEP'														, ; //X2_NOMESPA
	'ETIQUETAS SIGEP'														, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'PACOTES PLP'															, ; //X2_NOME
	'PACOTES PLP'															, ; //X2_NOMESPA
	'PACOTES PLP'															, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'NOTAS PRE LISTA DE POSTAGEM'											, ; //X2_NOME
	'NOTAS PRE LISTA DE POSTAGEM'											, ; //X2_NOMESPA
	'NOTAS PRE LISTA DE POSTAGEM'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	'Codigo Servico SIGEP'													, ; //X3_DESCRIC
	'Codigo Servico SIGEP'													, ; //X3_DESCSPA
	'Codigo Servico SIGEP'													, ; //X3_DESCENG
	'99999'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'ID Servico do SIGEP'													, ; //X3_DESCRIC
	'ID Servico do SIGEP'													, ; //X3_DESCSPA
	'ID Servico do SIGEP'													, ; //X3_DESCENG
	'999999'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Descricao do Servico'													, ; //X3_DESCRIC
	'Descricao do Servico'													, ; //X3_DESCSPA
	'Descricao do Servico'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod Tran Eco'															, ; //X3_TITULO
	'Cod Tran Eco'															, ; //X3_TITSPA
	'Cod Tran Eco'															, ; //X3_TITENG
	'Cod. Transportadora eComm'												, ; //X3_DESCRIC
	'Cod. Transportadora eComm'												, ; //X3_DESCSPA
	'Cod. Transportadora eComm'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Cod. Servico'															, ; //X3_TITSPA
	'Cod. Servico'															, ; //X3_TITENG
	'Codigo do Servico'														, ; //X3_DESCRIC
	'Codigo do Servico'														, ; //X3_DESCSPA
	'Codigo do Servico'														, ; //X3_DESCENG
	'99999'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Id Servico'															, ; //X3_TITSPA
	'Id Servico'															, ; //X3_TITENG
	'Id Servico SIGEP'														, ; //X3_DESCRIC
	'Id Servico SIGEP'														, ; //X3_DESCSPA
	'Id Servico SIGEP'														, ; //X3_DESCENG
	'999999'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod Etiqueta'															, ; //X3_TITULO
	'Cod Etiqueta'															, ; //X3_TITSPA
	'Cod Etiqueta'															, ; //X3_TITENG
	'Codigo Etiqueta'														, ; //X3_DESCRIC
	'Codigo Etiqueta'														, ; //X3_DESCSPA
	'Codigo Etiqueta'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Sigla Pais'															, ; //X3_TITULO
	'Sigla Pais'															, ; //X3_TITSPA
	'Sigla Pais'															, ; //X3_TITENG
	'Sigla Pais'															, ; //X3_DESCRIC
	'Sigla Pais'															, ; //X3_DESCSPA
	'Sigla Pais'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dig Etiqueta'															, ; //X3_TITULO
	'Dig Etiqueta'															, ; //X3_TITSPA
	'Dig Etiqueta'															, ; //X3_TITENG
	'Digito Etiqueta'														, ; //X3_DESCRIC
	'Digito Etiqueta'														, ; //X3_DESCSPA
	'Digito Etiqueta'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Numero PLP'															, ; //X3_TITULO
	'Numero PLP'															, ; //X3_TITSPA
	'Numero PLP'															, ; //X3_TITENG
	'Numero PLP'															, ; //X3_DESCRIC
	'Numero PLP'															, ; //X3_DESCSPA
	'Numero PLP'															, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Stat Env PLP'															, ; //X3_TITULO
	'Stat Env PLP'															, ; //X3_TITSPA
	'Stat Env PLP'															, ; //X3_TITENG
	'Status de Envio PLP'													, ; //X3_DESCRIC
	'Status de Envio PLP'													, ; //X3_DESCSPA
	'Status de Envio PLP'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Data Criacao'															, ; //X3_TITULO
	'Data Criacao'															, ; //X3_TITSPA
	'Data Criacao'															, ; //X3_TITENG
	'Data Criacao da PLP'													, ; //X3_DESCRIC
	'Data Criacao da PLP'													, ; //X3_DESCSPA
	'Data Criacao da PLP'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Hora Criacao'															, ; //X3_DESCRIC
	'Hora Criacao'															, ; //X3_DESCSPA
	'Hora Criacao'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hr Alteracao'															, ; //X3_TITULO
	'Hr Alteracao'															, ; //X3_TITSPA
	'Hr Alteracao'															, ; //X3_TITENG
	'Hora Alteracao'														, ; //X3_DESCRIC
	'Hora Alteracao'														, ; //X3_DESCSPA
	'Hora Alteracao'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'GETSXENUM("ZZ3","ZZ3_CODIGO")'											, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tp Embalagem'															, ; //X3_TITULO
	'Tp Embalagem'															, ; //X3_TITSPA
	'Tp Embalagem'															, ; //X3_TITENG
	'Tipo de Embalagem'														, ; //X3_DESCRIC
	'Tipo de Embalagem'														, ; //X3_DESCSPA
	'Tipo de Embalagem'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Caixa;2=Envelope'													, ; //X3_CBOX
	'1=Caixa;2=Envelope'													, ; //X3_CBOXSPA
	'1=Caixa;2=Envelope'													, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Altura'																, ; //X3_TITSPA
	'Altura'																, ; //X3_TITENG
	'Altura Centimetros'													, ; //X3_DESCRIC
	'Altura Centimetros'													, ; //X3_DESCSPA
	'Altura Centimetros'													, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Largura'																, ; //X3_TITSPA
	'Largura'																, ; //X3_TITENG
	'Largura Centimetros'													, ; //X3_DESCRIC
	'Largura Centimetros'													, ; //X3_DESCSPA
	'Largura Centimetros'													, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Comprimento'															, ; //X3_TITULO
	'Comprimento'															, ; //X3_TITSPA
	'Comprimento'															, ; //X3_TITENG
	'Comprimento Centimetros'												, ; //X3_DESCRIC
	'Comprimento Centimetros'												, ; //X3_DESCSPA
	'Comprimento Centimetros'												, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pre Lista ID'															, ; //X3_TITULO
	'Pre Lista ID'															, ; //X3_TITSPA
	'Pre Lista ID'															, ; //X3_TITENG
	'Pre Lista de Postagem ID'												, ; //X3_DESCRIC
	'Pre Lista de Postagem ID'												, ; //X3_DESCSPA
	'Pre Lista de Postagem ID'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Cod. Serv Po'															, ; //X3_TITSPA
	'Cod. Serv Po'															, ; //X3_TITENG
	'Cod. Servico Postagem'													, ; //X3_DESCRIC
	'Cod. Servico Postagem'													, ; //X3_DESCSPA
	'Cod. Servico Postagem'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod. Embalag'															, ; //X3_TITULO
	'Cod. Embalag'															, ; //X3_TITSPA
	'Cod. Embalag'															, ; //X3_TITENG
	'Codigo Embalagem'														, ; //X3_DESCRIC
	'Codigo Embalagem'														, ; //X3_DESCSPA
	'Codigo Embalagem'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Order ID eCo'															, ; //X3_TITULO
	'Order ID eCo'															, ; //X3_TITSPA
	'Order ID eCo'															, ; //X3_TITENG
	'Order ID eCommerce'													, ; //X3_DESCRIC
	'Order ID eCommerce'													, ; //X3_DESCSPA
	'Order ID eCommerce'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pedido ERP'															, ; //X3_TITULO
	'Pedido ERP'															, ; //X3_TITSPA
	'Pedido ERP'															, ; //X3_TITENG
	'Pedido ERP'															, ; //X3_DESCRIC
	'Pedido ERP'															, ; //X3_DESCSPA
	'Pedido ERP'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZZ0'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZZ0_FILIAL+ZZ0_CODSER'													, ; //CHAVE
	'Cod. Servico'															, ; //DESCRICAO
	'Cod. Servico'															, ; //DESCSPA
	'Cod. Servico'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'ZZ1'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'ZZ1_FILIAL+ZZ1_NOTA+ZZ1_SERIE'											, ; //CHAVE
	'Documento+Serie'														, ; //DESCRICAO
	'Documento+Serie'														, ; //DESCSPA
	'Documento+Serie'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	...
	'Pre Lista ID+Nota+Serie'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDSIGEP" ) ) ) ;
