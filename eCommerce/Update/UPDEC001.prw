...
/*/
//--------------------------------------------------------------------
User Function UPDEC001( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDDAN01" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDDAN01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Id Categoria' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAY0_XIDCAT", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "AY0_XIDCAT" )

aHlpPor := {}
aAdd( aHlpPor, 'Data Exportacao eCommerce' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAY0_XDTEXP", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "AY0_XDTEXP" )
...
PutHelp( "PAY0_XHREXP", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "AY0_XHREXP" )
...
PutHelp( "PAY2_XDTEXP", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "AY2_XDTEXP" )
...
PutHelp( "PAY2_XHREXP", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "AY2_XHREXP" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDDAN01" ) ) ) ;
