...
_cQuery += "		INNER JOIN " + RetSqlName("SE1") + " E1 ON E1.E1_FILORIG = XTA.XTA_FILIAL AND E1.E1_PARCELA = XTA.XTA_PARC AND E1.E1_XTID = XTA.XTA_IDPAY AND E1.E1_BAIXA = '' AND E1.E1_SALDO > 0 AND E1.D_E_L_E_T_ = '' " + CRLF
_cQuery += "	WHERE " + CRLF
