...
// Consulta saldo |
//----------------+
FWMsgRun(, {|| DnFinA04A(@_nReceber,@_nDisponivel,@_nTransferido) },"Aguarde...","Consultando saldo.")

If _nReceber > 0 .Or. _nDisponivel > 0 .Or. _nTransferido > 0 
    FwMsgRun(,{|| DnFinA04B(_nReceber,_nDisponivel,_nTransferido)},"Aguarde...","Criando tela.")
EndIf
...
/*/
/********************************************************************************************************************/
Static Function DnFinA04A(_nReceber,_nDisponivel,_nTransferido)
Local _cMsg     := ""
...
/*/
/********************************************************************************************************************/
Static Function DnFinA04B(_nReceber,_nDisponivel,_nTransferido)
...
DnFinA04C(@_cFileHtml,_nReceber,_nDisponivel,_nTransferido)
...
/*/
/******************************************************************************************/
Static Function DnFinA04C(_cFileHtml,_nReceber,_nDisponivel,_nTransferido)
Local _nHdl     := 0
Local _cTxtHtm  := ""

_cTxtHtm := '<table style="border:1px solid black;border-spacing:1px;text-align:center;width:100%">'
_cTxtHtm += '	<tr>'
_cTxtHtm += '		<th colspan="3"><img src="https://danacosmeticos.vteximg.com.br/arquivos/dana-logo-002.png" style="width:200px;height:100px;" > </th>'
_cTxtHtm += '	</tr>'
_cTxtHtm += '	<tr style="color:#fff;font-family: verdana;font-size: 100%;background-color:#333;">'
