...
/* ===============================================================================
WSDL Location    http://webservice-bluz.vtexcommerce.com.br/AdminWebService/Service.svc?wsdl
Gerado em        08/21/22 15:19:46
...
User Function _STENGTK ; Return  // "dummy" function - Internal Use 
...
If !FindFunction("XMLCHILDEX")
	UserException("O Código-Fonte Client atual requer os executáveis do Protheus Build [7.00.131227A-20161118] ou superior. Atualize o Protheus ou gere o Código-Fonte novamente utilizando o Build atual.")
EndIf
...
WSMETHOD StockKeepingUnitInsertUpdate WSSEND oWSstockKeepingUnitVO WSRECEIVE oWSStockKeepingUnitInsertUpdateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<StockKeepingUnitInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("stockKeepingUnitVO", ::oWSstockKeepingUnitVO, oWSstockKeepingUnitVO , "StockKeepingUnitDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
cSoap += "</StockKeepingUnitInsertUpdate>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://tempuri.org/IService/StockKeepingUnitInsertUpdate",; 
	"DOCUMENT","http://tempuri.org/",,,; 
	"http://webservice-bluz.vtexcommerce.com.br/AdminWebService/Service.svc")
...
WSMETHOD StockKeepingUnitPriceUpdate WSSEND nstockKeepintUnitId,nprice,nlistPrice,ncostPrice WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitPriceUpdateByRefId WSSEND cstockKeepintUnitRefId,nprice,nlistPrice,ncostPrice WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitGet WSSEND nid WSRECEIVE oWSStockKeepingUnitGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitGetByManufacturerCode WSSEND cmanufacturer WSRECEIVE oWSStockKeepingUnitGetByManufacturerCodeResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitGetByRefId WSSEND crefId WSRECEIVE oWSStockKeepingUnitGetByRefIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductInsertUpdate WSSEND oWSproductVO WSRECEIVE oWSProductInsertUpdateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<ProductInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("productVO", ::oWSproductVO, oWSproductVO , "ProductDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ProductGet WSSEND nidProduct WSRECEIVE oWSProductGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductGetByRefId WSSEND crefId WSRECEIVE oWSProductGetByRefIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductGetSimilarCategory WSSEND nproductId WSRECEIVE oWSProductGetSimilarCategoryResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductGetAllFromUpdatedDateAndId WSSEND cdateUpdated,nproductid,ntopRows WSRECEIVE oWSProductGetAllFromUpdatedDateAndIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductActive WSSEND nidProduct WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitKitListByParent WSSEND nidSkuParent WSRECEIVE oWSStockKeepingUnitKitListByParentResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitKitListBySkuId WSSEND nidSku WSRECEIVE oWSStockKeepingUnitKitListBySkuIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitKitDeleteByParent WSSEND nidSkuParent WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitKitInsertUpdate WSSEND oWSstockKeepingUnitKit WSRECEIVE oWSStockKeepingUnitKitInsertUpdateResult,nstockKeepingUnitKitId WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<StockKeepingUnitKitInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("stockKeepingUnitKit", ::oWSstockKeepingUnitKit, oWSstockKeepingUnitKit , "StockKeepingUnitKitDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD StockKeepingUnitActive WSSEND nidStockKeepingUnit WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitGetAllByProduct WSSEND nidProduct WSRECEIVE oWSStockKeepingUnitGetAllByProductResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitGetByEan WSSEND cEAN13 WSRECEIVE oWSStockKeepingUnitGetByEanResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ServiceGet WSSEND nidService WSRECEIVE oWSServiceGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ServicePriceGet WSSEND nidServicePrice WSRECEIVE oWSServicePriceGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ServicePriceList WSSEND nidService WSRECEIVE oWSServicePriceListResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ServiceInsertUpdate WSSEND oWSservice WSRECEIVE oWSServiceInsertUpdateResult,nserviceId WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<ServiceInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("service", ::oWSservice, oWSservice , "ServiceDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ServicePriceInsertUpdate WSSEND oWSservicePrice WSRECEIVE oWSServicePriceInsertUpdateResult,nservicePriceId WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<ServicePriceInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("servicePrice", ::oWSservicePrice, oWSservicePrice , "ServicePriceDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD StockKeepingUnitServiceGet WSSEND nidStockKeepingUnitService WSRECEIVE oWSStockKeepingUnitServiceGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitServiceList WSSEND nidSku WSRECEIVE oWSStockKeepingUnitServiceListResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitServiceInsertUpdate WSSEND oWSstockKeepingUnitService WSRECEIVE oWSStockKeepingUnitServiceInsertUpdateResult,nstockKeepingUnitServiceId WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<StockKeepingUnitServiceInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("stockKeepingUnitService", ::oWSstockKeepingUnitService, oWSstockKeepingUnitService , "StockKeepingUnitServiceDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD BrandGet WSSEND nidBrand WSRECEIVE oWSBrandGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD BrandGetByName WSSEND cnameBrand WSRECEIVE oWSBrandGetByNameResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD BrandInsertUpdate WSSEND oWSbrand WSRECEIVE oWSBrandInsertUpdateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<BrandInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("brand", ::oWSbrand, oWSbrand , "BrandDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD CategoryGet WSSEND nidCategory WSRECEIVE oWSCategoryGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD CategoryGetByName WSSEND cnameCategory WSRECEIVE oWSCategoryGetByNameResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD CategoryInsertUpdate WSSEND oWScategory WSRECEIVE oWSCategoryInsertUpdateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<CategoryInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("category", ::oWScategory, oWScategory , "CategoryDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ImageServiceCopyAllImagesFromSkuToSku WSSEND nstockKeepingUnitIdFrom,nstockKeepingUnitIdTo WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ImageServiceInsertUpdate WSSEND curlImage,cimageName,nstockKeepingUnitId,nfileId WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ImageInsertUpdate WSSEND oWSimage WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<ImageInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("image", ::oWSimage, oWSimage , "ImageDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ImageListByStockKeepingUnitId WSSEND nStockKeepingUnitId,nArchiveTypeId WSRECEIVE oWSImageListByStockKeepingUnitIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitImageRemove WSSEND nstockKeepingUnitId WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitImageRemoveByName WSSEND cimageName WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitEspecificationListBySkuId WSSEND nskuId WSRECEIVE oWSStockKeepingUnitEspecificationListBySkuIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductEspecificationListByProductId WSSEND nproductId WSRECEIVE oWSProductEspecificationListByProductIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitComplementInsertUpdate WSSEND oWSobjStockKeepingUnitComplementDTO WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<StockKeepingUnitComplementInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("objStockKeepingUnitComplementDTO", ::oWSobjStockKeepingUnitComplementDTO, oWSobjStockKeepingUnitComplementDTO , "StockKeepingUnitComplementDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ProductEspecificationInsert WSSEND nidProduct,cfieldName,oWSfieldValues WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
cSoap += WSSoapValue("fieldValues", ::oWSfieldValues, oWSfieldValues , "ArrayOfstring", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ProductEspecificationInsertByList WSSEND oWSlistProductFieldName WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<ProductEspecificationInsertByList xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("listProductFieldName", ::oWSlistProductFieldName, oWSlistProductFieldName , "ArrayOfProductFieldNameDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ProductEspecificationInsertByFieldId WSSEND nidProduct,nfieldId,oWSfieldValues WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductEspecificationInsertByListFieldIds WSSEND oWSlistStockKeepingUnitEspecificationFieldId WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<ProductEspecificationInsertByListFieldIds xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("listStockKeepingUnitEspecificationFieldId", ::oWSlistStockKeepingUnitEspecificationFieldId, oWSlistStockKeepingUnitEspecificationFieldId , "ArrayOfProductFieldIdDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD ProductEspecificationTextInsertByFieldId WSSEND nidProduct,nfieldId,cDescription WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitEspecificationInsertByList WSSEND oWSlistStockKeepingUnitName WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<StockKeepingUnitEspecificationInsertByList xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("listStockKeepingUnitName", ::oWSlistStockKeepingUnitName, oWSlistStockKeepingUnitName , "ArrayOfStockKeepingUnitFieldNameDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD StockKeepingUnitEspecificationInsert WSSEND nidSku,cfieldName,oWSfieldValues WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD ProductSetSimilarCategory WSSEND nproductId,ncategoryId WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StoreList WSSEND NULLPARAM WSRECEIVE oWSStoreListResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StoreGet WSSEND nstoreId WSRECEIVE oWSStoreGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD StockKeepingUnitEspecificationInsertByFieldId WSSEND nidSku,nfieldId,oWSfieldValues WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftCardInsertUpdate WSSEND oWSgiftcard WSRECEIVE oWSGiftCardInsertUpdateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<GiftCardInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("giftcard", ::oWSgiftcard, oWSgiftcard , "GiftCardDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD GiftCardTransactionItemInsert WSSEND oWSgiftCardTransactionItem WSRECEIVE lGiftCardTransactionItemInsertResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<GiftCardTransactionItemInsert xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("giftCardTransactionItem", ::oWSgiftCardTransactionItem, oWSgiftCardTransactionItem , "GiftCardTransactionItemDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD GiftListGet WSSEND nidGiftList WSRECEIVE oWSGiftListGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetByClientEmail WSSEND cclientEmail WSRECEIVE oWSGiftListGetByClientEmailResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetByClientCpf WSSEND cclientCpfCnpj WSRECEIVE oWSGiftListGetByClientCpfResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetType WSSEND ngiftListTypeId WSRECEIVE oWSGiftListGetTypeResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetByCreatedDate WSSEND ccreatedDate WSRECEIVE oWSGiftListGetByCreatedDateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetAllFromCreatedDateAndId WSSEND ccreatedDate,nstartingGiftListId,ntopRows WSRECEIVE oWSGiftListGetAllFromCreatedDateAndIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetAllBetweenEventDateIntervalAndId WSSEND ceventDateBegin,ceventDateEnd,nstartingGiftListId,ntopRows WSRECEIVE oWSGiftListGetAllBetweenEventDateIntervalAndIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetByModifiedDate WSSEND cmodifiedDate WSRECEIVE oWSGiftListGetByModifiedDateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetAllFromModifiedDateAndId WSSEND cmodifiedDate,nstartingGiftListId,ntopRows WSRECEIVE oWSGiftListGetAllFromModifiedDateAndIdResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListGetByGifted WSSEND cgifted WSRECEIVE oWSGiftListGetByGiftedResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListInsertUpdate WSSEND oWSgiftList WSRECEIVE oWSGiftListInsertUpdateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<GiftListInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("giftList", ::oWSgiftList, oWSgiftList , "GiftListDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD GiftListV2Filters WSSEND ngiftListTypeId,ngiftListId,nclientId,ceventDateSince,ceventDateUntil,lisActive WSRECEIVE oWSGiftListV2FiltersResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListSearch WSSEND cclientName,ceventLocation,ceventCity,ceventDate WSRECEIVE oWSGiftListSearchResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListSearchWithSurname WSSEND cclientName,cclientSurname,ceventLocation,ceventCity,ceventDate WSRECEIVE oWSGiftListSearchWithSurnameResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListMemberInsertUpdate WSSEND oWSgiftListMember WSRECEIVE oWSGiftListMemberInsertUpdateResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<GiftListMemberInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("giftListMember", ::oWSgiftListMember, oWSgiftListMember , "ArrayOfGiftListMemberDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD GiftListMemberDelete WSSEND nGiftListMemberId,nGiftListId WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListSkuInsert WSSEND oWSgiftListSku WSRECEIVE oWSGiftListSkuInsertResult WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<GiftListSkuInsert xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("giftListSku", ::oWSgiftListSku, oWSgiftListSku , "GiftListStockKeepingUnitDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD GiftListSkuGet WSSEND nidGiftList WSRECEIVE oWSGiftListSkuGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListSkuSetPurchased WSSEND ngiftListId,nskuId,nQuantity,norderId WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftListSkuDeleteByList WSSEND ngiftListId,oWSskuQuantity WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
cSoap += WSSoapValue("giftListId", ::ngiftListId, ngiftListId , "int", .F. , .F., 0 , NIL, .F.) 
cSoap += WSSoapValue("skuQuantity", ::oWSskuQuantity, oWSskuQuantity , "ArrayOfStockKeepingUnitQuantityDTO", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD GiftListSkuDelete WSSEND ngiftListId,nskuId,nQuantity WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftCardGet WSSEND nId WSRECEIVE oWSGiftCardGetResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD GiftCardGetByRedeptionCode WSSEND credeptionCode WSRECEIVE oWSGiftCardGetByRedeptionCodeResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD IntegrationLogErrorInsertUpdate WSSEND oWSerrorType,cinstance,cerror,cerrorDetail WSRECEIVE NULLPARAM WSCLIENT WSService
Local cSoap := "" , oXmlRet

BEGIN WSMETHOD

cSoap += '<IntegrationLogErrorInsertUpdate xmlns="http://tempuri.org/">'
cSoap += WSSoapValue("errorType", ::oWSerrorType, oWSerrorType , "ErrorType", .F. , .F., 0 , "http://tempuri.org/", .F.) 
...
WSMETHOD IntegrationErrorCheckInstanceExists WSSEND oWSerrorType,cinstance WSRECEIVE lIntegrationErrorCheckInstanceExistsResult WSCLIENT WSService
Local cSoap := "" , oXmlRet
...
WSMETHOD SOAPSEND WSCLIENT Service_StockKeepingUnitDTO
	Local cSoap := ""
	cSoap += WSSoapValue("CommercialConditionId", ::nCommercialConditionId, ::nCommercialConditionId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("CostPrice", ::nCostPrice, ::nCostPrice , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("CubicWeight", ::nCubicWeight, ::nCubicWeight , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("DateUpdated", ::cDateUpdated, ::cDateUpdated , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("EstimatedDateArrival", ::cEstimatedDateArrival, ::cEstimatedDateArrival , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Height", ::nHeight, ::nHeight , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Id", ::nId, ::nId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("InternalNote", ::cInternalNote, ::cInternalNote , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsActive", ::lIsActive, ::lIsActive , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsAvaiable", ::lIsAvaiable, ::lIsAvaiable , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsKit", ::lIsKit, ::lIsKit , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Length", ::nLength, ::nLength , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ListPrice", ::nListPrice, ::nListPrice , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ManufacturerCode", ::cManufacturerCode, ::cManufacturerCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("MeasurementUnit", ::cMeasurementUnit, ::cMeasurementUnit , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ModalId", ::nModalId, ::nModalId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ModalType", ::cModalType, ::cModalType , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Price", ::nPrice, ::nPrice , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ProductId", ::nProductId, ::nProductId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ProductName", ::cProductName, ::cProductName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RealHeight", ::nRealHeight, ::nRealHeight , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RealLength", ::nRealLength, ::nRealLength , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RealWeightKg", ::nRealWeightKg, ::nRealWeightKg , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RealWidth", ::nRealWidth, ::nRealWidth , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RefId", ::cRefId, ::cRefId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RewardValue", ::nRewardValue, ::nRewardValue , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitEans", ::oWSStockKeepingUnitEans, ::oWSStockKeepingUnitEans , "ArrayOfStockKeepingUnitEanDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("UnitMultiplier", ::nUnitMultiplier, ::nUnitMultiplier , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("VenderSeparadamente", ::lVenderSeparadamente, ::lVenderSeparadamente , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("WeightKg", ::nWeightKg, ::nWeightKg , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Width", ::nWidth, ::nWidth , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ProductDTO
	Local cSoap := ""
	cSoap += WSSoapValue("AdWordsRemarketingCode", ::cAdWordsRemarketingCode, ::cAdWordsRemarketingCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("BrandId", ::nBrandId, ::nBrandId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("CategoryId", ::nCategoryId, ::nCategoryId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("DepartmentId", ::nDepartmentId, ::nDepartmentId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Description", ::cDescription, ::cDescription , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("DescriptionShort", ::cDescriptionShort, ::cDescriptionShort , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Id", ::nId, ::nId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsActive", ::lIsActive, ::lIsActive , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsVisible", ::lIsVisible, ::lIsVisible , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("KeyWords", ::cKeyWords, ::cKeyWords , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("LinkId", ::cLinkId, ::cLinkId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ListStoreId", ::oWSListStoreId, ::oWSListStoreId , "ArrayOfint", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("LomadeeCampaignCode", ::cLomadeeCampaignCode, ::cLomadeeCampaignCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("MetaTagDescription", ::cMetaTagDescription, ::cMetaTagDescription , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RefId", ::cRefId, ::cRefId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ReleaseDate", ::cReleaseDate, ::cReleaseDate , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Score", ::nScore, ::nScore , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ShowWithoutStock", ::lShowWithoutStock, ::lShowWithoutStock , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("SupplierId", ::nSupplierId, ::nSupplierId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("TaxCode", ::cTaxCode, ::cTaxCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Title", ::cTitle, ::cTitle , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_StockKeepingUnitKitDTO
	Local cSoap := ""
	cSoap += WSSoapValue("Amount", ::nAmount, ::nAmount , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Id", ::nId, ::nId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitId", ::nStockKeepingUnitId, ::nStockKeepingUnitId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitParent", ::nStockKeepingUnitParent, ::nStockKeepingUnitParent , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("UnitPrice", ::nUnitPrice, ::nUnitPrice , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ServiceDTO
	...
	cSoap += WSSoapValue("Id", ::nId, ::nId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsActive", ::lIsActive, ::lIsActive , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsFile", ::lIsFile, ::lIsFile , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsGiftCard", ::lIsGiftCard, ::lIsGiftCard , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsRequired", ::lIsRequired, ::lIsRequired , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsVisibleOnCart", ::lIsVisibleOnCart, ::lIsVisibleOnCart , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsVisibleOnProduct", ::lIsVisibleOnProduct, ::lIsVisibleOnProduct , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsVisibleOnService", ::lIsVisibleOnService, ::lIsVisibleOnService , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ServicePriceDTO
	...
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Price", ::nPrice, ::nPrice , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Service", ::oWSService, ::oWSService , "ServiceDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ServiceId", ::nServiceId, ::nServiceId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_StockKeepingUnitServiceDTO
	...
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ServiceId", ::nServiceId, ::nServiceId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ServicePrice", ::oWSServicePrice, ::oWSServicePrice , "ServicePriceDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ServicePriceId", ::nServicePriceId, ::nServicePriceId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitId", ::nStockKeepingUnitId, ::nStockKeepingUnitId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_CategoryDTO
	...
	cSoap += WSSoapValue("AdWordsRemarketingCode", ::cAdWordsRemarketingCode, ::cAdWordsRemarketingCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Description", ::cDescription, ::cDescription , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("FatherCategoryId", ::nFatherCategoryId, ::nFatherCategoryId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Id", ::nId, ::nId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsActive", ::lIsActive, ::lIsActive , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Keywords", ::cKeywords, ::cKeywords , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("LomadeeCampaignCode", ::cLomadeeCampaignCode, ::cLomadeeCampaignCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Score", ::nScore, ::nScore , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ShowBrandFilter", ::lShowBrandFilter, ::lShowBrandFilter , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Title", ::cTitle, ::cTitle , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_StockKeepingUnitComplementDTO
	Local cSoap := ""
	cSoap += WSSoapValue("ComplementType", ::oWSComplementType, ::oWSComplementType , "StockKeepingUnitComplementDTO.ComplementTypeEnum", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitComplements", ::oWSStockKeepingUnitComplements, ::oWSStockKeepingUnitComplements , "ArrayOfint", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitId", ::nStockKeepingUnitId, ::nStockKeepingUnitId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ArrayOfstring
	Local cSoap := ""
	aEval( ::cstring , {|x| cSoap := cSoap  +  WSSoapValue("string", x , x , "string", .F. , .F., 0 , "http://schemas.microsoft.com/2003/10/Serialization/Arrays", .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ArrayOfProductFieldNameDTO
	Local cSoap := ""
	aEval( ::oWSProductFieldNameDTO , {|x| cSoap := cSoap  +  WSSoapValue("ProductFieldNameDTO", x , x , "ProductFieldNameDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ArrayOfProductFieldIdDTO
	Local cSoap := ""
	aEval( ::oWSProductFieldIdDTO , {|x| cSoap := cSoap  +  WSSoapValue("ProductFieldIdDTO", x , x , "ProductFieldIdDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ArrayOfStockKeepingUnitFieldNameDTO
	Local cSoap := ""
	aEval( ::oWSStockKeepingUnitFieldNameDTO , {|x| cSoap := cSoap  +  WSSoapValue("StockKeepingUnitFieldNameDTO", x , x , "StockKeepingUnitFieldNameDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_GiftCardDTO
	Local cSoap := ""
	cSoap += WSSoapValue("EmissionDate", ::cEmissionDate, ::cEmissionDate , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ExpiringDate", ::cExpiringDate, ::cExpiringDate , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Funds", ::nFunds, ::nFunds , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Id", ::nId, ::nId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("MultipleCredits", ::lMultipleCredits, ::lMultipleCredits , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("MultipleRedemptions", ::lMultipleRedemptions, ::lMultipleRedemptions , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("OwnerId", ::cOwnerId, ::cOwnerId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RedeptionCode", ::cRedeptionCode, ::cRedeptionCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RestrictedToOwner", ::lRestrictedToOwner, ::lRestrictedToOwner , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StatusId", ::nStatusId, ::nStatusId , "short", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_GiftCardTransactionItemDTO
	Local cSoap := ""
	cSoap += WSSoapValue("OrderId", ::nOrderId, ::nOrderId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("RedemptionCode", ::cRedemptionCode, ::cRedemptionCode , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitId", ::nStockKeepingUnitId, ::nStockKeepingUnitId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("TransactionAction", ::oWSTransactionAction, ::oWSTransactionAction , "TransactionAction", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("TransactionConfirmed", ::lTransactionConfirmed, ::lTransactionConfirmed , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Value", ::nValue, ::nValue , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_GiftListDTO
	Local cSoap := ""
	cSoap += WSSoapValue("ClientAddressId", ::nClientAddressId, ::nClientAddressId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ClientId", ::nClientId, ::nClientId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("DateCreated", ::cDateCreated, ::cDateCreated , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("DateModified", ::cDateModified, ::cDateModified , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("EventCity", ::cEventCity, ::cEventCity , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("EventDate", ::cEventDate, ::cEventDate , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("EventLocation", ::cEventLocation, ::cEventLocation , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("EventState", ::cEventState, ::cEventState , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("FileId", ::nFileId, ::nFileId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("GiftCardId", ::nGiftCardId, ::nGiftCardId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("GiftListId", ::nGiftListId, ::nGiftListId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("GiftListMembers", ::oWSGiftListMembers, ::oWSGiftListMembers , "ArrayOfGiftListMemberDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("GiftListTypeId", ::nGiftListTypeId, ::nGiftListTypeId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Gifted", ::cGifted, ::cGifted , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsActive", ::lIsActive, ::lIsActive , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsPublic", ::lIsPublic, ::lIsPublic , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Message", ::cMessage, ::cMessage , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ProfileSystemUserAddressName", ::cProfileSystemUserAddressName, ::cProfileSystemUserAddressName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ProfileSystemUserId", ::cProfileSystemUserId, ::cProfileSystemUserId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("UrlFolder", ::cUrlFolder, ::cUrlFolder , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Version", ::nVersion, ::nVersion , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ArrayOfGiftListMemberDTO
	Local cSoap := ""
	aEval( ::oWSGiftListMemberDTO , {|x| cSoap := cSoap  +  WSSoapValue("GiftListMemberDTO", x , x , "GiftListMemberDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_GiftListStockKeepingUnitDTO
	Local cSoap := ""
	cSoap += WSSoapValue("DateCreated", ::cDateCreated, ::cDateCreated , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("DatePurchased", ::cDatePurchased, ::cDatePurchased , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("FreightAndServicesValue", ::nFreightAndServicesValue, ::nFreightAndServicesValue , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("GiftListId", ::nGiftListId, ::nGiftListId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("GiftListSkuId", ::nGiftListSkuId, ::nGiftListSkuId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("InsertedByClientId", ::nInsertedByClientId, ::nInsertedByClientId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("InsertedByProfileSystemUserId", ::cInsertedByProfileSystemUserId, ::cInsertedByProfileSystemUserId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ItemValue", ::nItemValue, ::nItemValue , "decimal", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("OmsOrderId", ::cOmsOrderId, ::cOmsOrderId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("OrderId", ::nOrderId, ::nOrderId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("OrderMessage", ::cOrderMessage, ::cOrderMessage , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("OrderMessageFrom", ::cOrderMessageFrom, ::cOrderMessageFrom , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("OrderMessageTo", ::cOrderMessageTo, ::cOrderMessageTo , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("OrderResponseMessage", ::cOrderResponseMessage, ::cOrderResponseMessage , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("SkuId", ::nSkuId, ::nSkuId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("WishedByClientId", ::nWishedByClientId, ::nWishedByClientId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("WishedByProfileSystemUserId", ::cWishedByProfileSystemUserId, ::cWishedByProfileSystemUserId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("_IsOrderFinished", ::l_IsOrderFinished, ::l_IsOrderFinished , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ArrayOfStockKeepingUnitQuantityDTO
	Local cSoap := ""
	aEval( ::oWSStockKeepingUnitQuantityDTO , {|x| cSoap := cSoap  +  WSSoapValue("StockKeepingUnitQuantityDTO", x , x , "StockKeepingUnitQuantityDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ArrayOfStockKeepingUnitEanDTO
	Local cSoap := ""
	aEval( ::oWSStockKeepingUnitEanDTO , {|x| cSoap := cSoap  +  WSSoapValue("StockKeepingUnitEanDTO", x , x , "StockKeepingUnitEanDTO", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ImageDTO
	Local cSoap := ""
	cSoap += WSSoapValue("ArchiveFormatId", ::nArchiveFormatId, ::nArchiveFormatId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ArchiveParentId", ::nArchiveParentId, ::nArchiveParentId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ArchiveTypeId", ::nArchiveTypeId, ::nArchiveTypeId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("DateLastModified", ::cDateLastModified, ::cDateLastModified , "dateTime", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Description", ::cDescription, ::cDescription , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("FileLocation", ::cFileLocation, ::cFileLocation , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Height", ::nHeight, ::nHeight , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("HeightUnitMeasure", ::cHeightUnitMeasure, ::cHeightUnitMeasure , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Id", ::nId, ::nId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsMain", ::lIsMain, ::lIsMain , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Label", ::cLabel, ::cLabel , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitId", ::nStockKeepingUnitId, ::nStockKeepingUnitId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Tag", ::cTag, ::cTag , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Url", ::cUrl, ::cUrl , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Width", ::nWidth, ::nWidth , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("WidthUnitMeasure", ::cWidthUnitMeasure, ::cWidthUnitMeasure , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ProductFieldNameDTO
	Local cSoap := ""
	cSoap += WSSoapValue("fieldName", ::cfieldName, ::cfieldName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("fieldValues", ::oWSfieldValues, ::oWSfieldValues , "ArrayOfstring", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("productid", ::nproductid, ::nproductid , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_ProductFieldIdDTO
	Local cSoap := ""
	cSoap += WSSoapValue("fieldId", ::nfieldId, ::nfieldId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("fieldValues", ::oWSfieldValues, ::oWSfieldValues , "ArrayOfstring", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("productid", ::nproductid, ::nproductid , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_StockKeepingUnitFieldNameDTO
	...
	cSoap += WSSoapValue("fieldName", ::cfieldName, ::cfieldName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("fieldValues", ::oWSfieldValues, ::oWSfieldValues , "ArrayOfstring", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("idSku", ::nidSku, ::nidSku , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_GiftListMemberDTO
	Local cSoap := ""
	cSoap += WSSoapValue("GiftListMemberId", ::nGiftListMemberId, ::nGiftListMemberId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("GiftListId", ::nGiftListId, ::nGiftListId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ClientId", ::nClientId, ::nClientId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Title", ::cTitle, ::cTitle , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Name", ::cName, ::cName , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Surname", ::cSurname, ::cSurname , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Mail", ::cMail, ::cMail , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Text1", ::cText1, ::cText1 , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("Text2", ::cText2, ::cText2 , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsAdmin", ::lIsAdmin, ::lIsAdmin , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("IsActive", ::lIsActive, ::lIsActive , "boolean", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("ProfileSystemUserId", ::cProfileSystemUserId, ::cProfileSystemUserId , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_StockKeepingUnitQuantityDTO
	Local cSoap := ""
	cSoap += WSSoapValue("Quantity", ::nQuantity, ::nQuantity , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
	cSoap += WSSoapValue("StockKeepingUnitId", ::nStockKeepingUnitId, ::nStockKeepingUnitId , "int", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT Service_StockKeepingUnitEanDTO
	Local cSoap := ""
	cSoap += WSSoapValue("Ean", ::cEan, ::cEan , "string", .F. , .F., 0 , "http://schemas.datacontract.org/2004/07/Vtex.Commerce.WebApps.AdminWcfService.Contracts", .F.) 
Return cSoap
