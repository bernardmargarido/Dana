...
/*/
//--------------------------------------------------------------------
User Function UPDEXPDL( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDEXPDL" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDEXPDL" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'DLog - Postagem'														, ; //X2_NOME
	'DLog - Postagem'														, ; //X2_NOMESPA
	'DLog - Postagem'														, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'dLog - Itens Postagem'													, ; //X2_NOME
	'dLog - Itens Postagem'													, ; //X2_NOMESPA
	'dLog - Itens Postagem'													, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'Codigo'																, .T. }, ; //X3_TITSPA
	{ 'Codigo'																, .T. }, ; //X3_TITENG
	{ 'Codigo Postagem'														, .T. }, ; //X3_DESCRIC
	{ 'Codigo Postagem'														, .T. }, ; //X3_DESCSPA
	{ 'Codigo Postagem'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Hora Envio'															, .T. }, ; //X3_DESCRIC
	{ 'Hora Envio'															, .T. }, ; //X3_DESCSPA
	{ 'Hora Envio'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Arq. Enviado'														, .T. }, ; //X3_TITULO
	{ 'Arq. Enviado'														, .T. }, ; //X3_TITSPA
	{ 'Arq. Enviado'														, .T. }, ; //X3_TITENG
	{ 'Arquivo enviado'														, .T. }, ; //X3_DESCRIC
	{ 'Arquivo enviado'														, .T. }, ; //X3_DESCSPA
	{ 'Arquivo enviado'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Postagem Gerada;2=Postagem Enviada;3=Erro de Envio'				, .T. }, ; //X3_CBOX
	{ '1=Postagem Gerada;2=Postagem Enviada;3=Erro de Envio'				, .T. }, ; //X3_CBOXSPA
	{ '1=Postagem Gerada;2=Postagem Enviada;3=Erro de Envio'				, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	{ 'ZZC'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZZC_NUMECO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Order ID'															, .T. }, ; //X3_TITULO
	{ 'Order ID'															, .T. }, ; //X3_TITSPA
	{ 'Order ID'															, .T. }, ; //X3_TITENG
	{ 'Order ID'															, .T. }, ; //X3_DESCRIC
	{ 'Order ID'															, .T. }, ; //X3_DESCSPA
	{ 'Order ID'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZZC'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZZC_NUMECL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 20																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Order ID eCo'														, .T. }, ; //X3_TITULO
	{ 'Order ID eCo'														, .T. }, ; //X3_TITSPA
	{ 'Order ID eCo'														, .T. }, ; //X3_TITENG
	{ 'Order ID eCommerce'													, .T. }, ; //X3_DESCRIC
	{ 'Order ID eCommerce'													, .T. }, ; //X3_DESCSPA
	{ 'Order ID eCommerce'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZZC'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'ZZC_NUMSC5'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Pedido ERP'															, .T. }, ; //X3_TITULO
	{ 'Pedido ERP'															, .T. }, ; //X3_TITSPA
	{ 'Pedido ERP'															, .T. }, ; //X3_TITENG
	{ 'Pedido ERP'															, .T. }, ; //X3_DESCRIC
	{ 'Pedido ERP'															, .T. }, ; //X3_DESCSPA
	{ 'Pedido ERP'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Arq. Retorno'														, .T. }, ; //X3_TITULO
	{ 'Arq. Retorno'														, .T. }, ; //X3_TITSPA
	{ 'Arq. Retorno'														, .T. }, ; //X3_TITENG
	{ 'Arquivo Retorno'														, .T. }, ; //X3_DESCRIC
	{ 'Arquivo Retorno'														, .T. }, ; //X3_DESCSPA
	{ 'Arquivo Retorno'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZZC'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZZC_FILIAL+ZZC_CODIGO+ZZC_ITEM'										, ; //CHAVE
...
aAdd( aSIX, { ;
	'ZZC'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZZC_FILIAL+ZZC_CODIGO+ZZC_NOTA+ZZC_SERIE'								, ; //CHAVE
	'Codigo+Nota+Serie'														, ; //DESCRICAO
	'Codigo+Nota+Serie'														, ; //DESCSPA
	'Codigo+Nota+Serie'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Codigo Postagem' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZB_CODIGO", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZB_CODIGO" )

aHlpPor := {}
aAdd( aHlpPor, 'Data do Envio' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZB_DATA  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZB_DATA" )

aHlpPor := {}
aAdd( aHlpPor, 'Hora do envio' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZB_HORA  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZB_HORA" )

aHlpPor := {}
aAdd( aHlpPor, 'Arquivo enviado' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZB_JSON  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZB_JSON" )
...
PutHelp( "PZZB_STATUS", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZB_STATUS" )
...
PutHelp( "PZZC_CODIGO", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_CODIGO" )
...
PutHelp( "PZZC_ITEM  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_ITEM" )
...
PutHelp( "PZZC_NOTA  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_NOTA" )
...
PutHelp( "PZZC_SERIE ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_SERIE" )

aHlpPor := {}
aAdd( aHlpPor, 'Order ID' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZC_NUMECO", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_NUMECO" )

aHlpPor := {}
aAdd( aHlpPor, 'Order ID eCommerce' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZC_NUMECL", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_NUMECL" )

aHlpPor := {}
aAdd( aHlpPor, 'Pedido ERP' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZC_NUMSC5", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_NUMSC5" )

aHlpPor := {}
aAdd( aHlpPor, 'Arquivo Retorno' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZZC_JSON  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_JSON" )
...
PutHelp( "PZZC_STATUS", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZC_STATUS" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDEXPDL" ) ) ) ;
