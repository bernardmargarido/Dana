...
_oDlg := MsDialog():New(000, 000, 375, 615,"Monitor Integrações",,,,,,,,,.T.)
	...
	@ 060,010 Button "07 ) Ativa Prod. X Sku"		Size 92,12 When _lATV  Action ( U_AECOI012()	, Eval(_bFlagEco) ) Pixel
...
//_cQuery += "		INNER JOIN " + RetSqlName("DA0") + " DA0 ON DA0.DA0_FILIAL = '" + xFilial("DA0") + "' AND DA0.DA0_CODTAB = DA1.DA1_CODTAB AND DA0.DA0_XSTATU = '1' AND DA0.D_E_L_E_T_ = '' " + CRLF 
...
_cQuery += "		DA1.DA1_ENVECO = '1' AND " + CRLF  
