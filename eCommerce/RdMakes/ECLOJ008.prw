...
//-----------------------------------------------+
oStruct := FWFormStruct(1,"WS4")

//----------------------------------+
// Cria o Objeto do Modelo de Dados |
//----------------------------------+
oModel	:= MPFormModel():New("WS4_00",,{|oModel| EcLoj08TOk(oModel) })

//-----------------------------------------------+
// Adiciona ao modelo o componente de formulário |
//-----------------------------------------------+
oModel:AddFields("WS4MASTER",/*cOwner*/,oStruct)

//---------------------+
// Cria Chave Primaria |
//---------------------+
oModel:SetPrimaryKey( {"WS4_FILIAL","WS4_CODIGO"} )
...
//-------------------------------------------------------+
oModel:GetModel('WS4MASTER'):SetDescription('Operadoras Pagamento eCommerce')
...
// (antiga Enchoice)                                     |
//-------------------------------------------------------+
oDefView:AddField( 'VIEW_WS4', oDefStruct, 'WS4MASTER' ) 
...
//------------------------------------------------------------------+
oDefView:SetOwnerView( 'VIEW_WS4', 'TELA' ) 
