...
TRCell():New(oSection1,"nDab","   ","Desc. Abat",PesqPict("SA1","A1_DESCABT"),TamSX3("A1_DESCABT")[1],/*lPixel*/,{|| nDab })
...
While TRB1->(!EOF())
	...
	cQueryZ= " SELECT A1_NOME NOME, A1_CGC CGC, A1_DESCABT FROM " + RetSqlName("SA1") + " (NOLOCK) "
	...
	//-- Percentual desconto cadastro cliente
	oSection1:Cell("nDab"):SetValue(nDes)
