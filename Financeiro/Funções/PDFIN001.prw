...
cAccount	:= "contasareceber@danacosmeticos.com.br" //GetNewPar("MV_RELACNT","")
cPassword	:= "3IGXJj&l9w" //GetNewPar("MV_RELPSW","")
cFrom		:= "contasareceber@danacosmeticos.com.br" //GetNewPar("MV_RELFROM",.F.)
lMailAuth	:= GetNewPar("MV_RELAUTH",.F.)
lUseTls		:= GetNewPar("MV_RELTLS")
lUseSsl		:= GetNewPar("MV_RELSSL")
cContFin	:= GetNewPar("MV_XMAISE4","") //E-mail da equipe financeira.
cContCom	:= GetNewPar("MV_XMAICOM","") //E-mail da equipe Comercial
dVencRea	:= Date() - 2
