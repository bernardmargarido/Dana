...
/*/{Protheus.doc} Zendesk
    @description Classe realiza as integrações Protheus X Zendesk
...
/****************************************************************************************/
/*/{Protheus.doc} Token
    @description Método retrona token acesso as API's
    @author    Bernard M. Margarido
    @since     22/11/2020
/*/
/****************************************************************************************/
...
/*/{Protheus.doc} SetToken
    @description Método gera token acesso as API's
    @author    Bernard M. Margarido
    @since     22/11/2020
/*/
/****************************************************************************************/
...
/****************************************************************************************/
/*/{Protheus.doc} Token
    @description Método valida token de acesso as API's 
    @author    Bernard M. Margarido
    @since     22/11/2020
/*/
/****************************************************************************************/
...
/****************************************************************************************/
/*/{Protheus.doc} Pedido
    @description Método retorna status atual dos pedidos
    @author    Bernard M. Margarido
    @since     22/11/2020
/*/
/****************************************************************************************/
...
/****************************************************************************************/
/*/{Protheus.doc} Boleto 
    @description Método retorna 2via do boleto 
    @author    Bernard M. Margarido
    @since     22/11/2020
/*/
/****************************************************************************************/
